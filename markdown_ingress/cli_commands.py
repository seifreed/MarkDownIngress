...
def cmd_benchmark(args):
    ...
    urls = load_urls_from_file(args.file)
    fetcher_factory = _api.benchmark_fetcher_factory() if args.compare_extractors else None
    _compare_fn = _api.compare_extractors if args.compare_extractors else None
    bench = Benchmark(

...
create_batch_processor  # unused function (markdown_ingress/cli_commands.py:76)
process_batch_with_progress  # unused function (markdown_ingress/cli_commands.py:138)
